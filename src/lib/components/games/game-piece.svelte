...
<button command="show-modal" commandfor="{game.title}-dialog" class="p-2 hover:bg-hover rounded-lg flex flex-col justify-between cursor-pointer border-2 border-text font-semibold {classes}">
