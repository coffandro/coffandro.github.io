...
var ASM_CONSTS = {
  2134972: ($0, $1) => { Module.canvas.dispatchEvent(new CustomEvent('game-event', { detail: { type: $0, data: $1 }, bubbles: true })); },  
 2135087: () => { if (document.fullscreenElement) return 1; },  
 2135133: () => { return Module.canvas.width; },  
 2135165: () => { return parseInt(Module.canvas.style.width); },  
 2135213: () => { document.exitFullscreen(); },  
 2135240: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 2135312: () => { if (document.fullscreenElement) return 1; },  
 2135358: () => { return Module.canvas.width; },  
 2135390: () => { return screen.width; },  
 2135415: () => { document.exitFullscreen(); },  
 2135442: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 2135575: () => { return window.innerWidth; },  
 2135601: () => { return window.innerHeight; },  
 2135628: () => { if (document.fullscreenElement) return 1; },  
 2135674: () => { return Module.canvas.width; },  
 2135706: () => { return parseInt(Module.canvas.style.width); },  
 2135754: () => { if (document.fullscreenElement) return 1; },  
 2135800: () => { return Module.canvas.width; },  
 2135832: () => { return screen.width; },  
 2135857: () => { return window.innerWidth; },  
 2135883: () => { return window.innerHeight; },  
 2135910: () => { if (document.fullscreenElement) return 1; },  
 2135956: () => { return Module.canvas.width; },  
 2135988: () => { return screen.width; },  
 2136013: () => { document.exitFullscreen(); },  
 2136040: () => { if (document.fullscreenElement) return 1; },  
 2136086: () => { return Module.canvas.width; },  
 2136118: () => { return parseInt(Module.canvas.style.width); },  
 2136166: () => { document.exitFullscreen(); },  
 2136193: ($0) => { Module.canvas.style.opacity = $0; },  
 2136231: () => { return screen.width; },  
 2136256: () => { return screen.height; },  
 2136282: () => { return window.screenX; },  
 2136309: () => { return window.screenY; },  
 2136336: () => { return window.devicePixelRatio; },  
 2136372: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 2136425: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 2136476: () => { Module.canvas.style.cursor = 'none'; },  
 2136513: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 2136769: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 2136820: () => { if (document.pointerLockElement) return 1; },  
 2136867: () => { if (document.fullscreenElement) return 1; },  
 2136913: () => { return window.innerWidth; },  
 2136939: () => { return window.innerHeight; }
};
function SetCanvasIdJs(out,outSize) { var canvasId = "#" + Module.canvas.id; stringToUTF8(canvasId, out, outSize); }

// Imports from the Wasm binary.
var _set_touch_mode = Module['_set_touch_mode'] = makeInvalidEarlyAccess('_set_touch_mode');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['set_touch_mode'] != 'undefined', 'missing Wasm export: set_touch_mode');
  ...
  _set_touch_mode = Module['_set_touch_mode'] = createExportWrapper('set_touch_mode', 1);
