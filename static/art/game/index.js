...
var ASM_CONSTS = {
  2134856: ($0, $1) => { Module.canvas.dispatchEvent(new CustomEvent('game-event', { detail: { type: $0, data: $1 }, bubbles: true })); },  
 2134971: () => { if (document.fullscreenElement) return 1; },  
 2135017: () => { return Module.canvas.width; },  
 2135049: () => { return parseInt(Module.canvas.style.width); },  
 2135097: () => { document.exitFullscreen(); },  
 2135124: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 2135196: () => { if (document.fullscreenElement) return 1; },  
 2135242: () => { return Module.canvas.width; },  
 2135274: () => { return screen.width; },  
 2135299: () => { document.exitFullscreen(); },  
 2135326: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 2135459: () => { return window.innerWidth; },  
 2135485: () => { return window.innerHeight; },  
 2135512: () => { if (document.fullscreenElement) return 1; },  
 2135558: () => { return Module.canvas.width; },  
 2135590: () => { return parseInt(Module.canvas.style.width); },  
 2135638: () => { if (document.fullscreenElement) return 1; },  
 2135684: () => { return Module.canvas.width; },  
 2135716: () => { return screen.width; },  
 2135741: () => { return window.innerWidth; },  
 2135767: () => { return window.innerHeight; },  
 2135794: () => { if (document.fullscreenElement) return 1; },  
 2135840: () => { return Module.canvas.width; },  
 2135872: () => { return screen.width; },  
 2135897: () => { document.exitFullscreen(); },  
 2135924: () => { if (document.fullscreenElement) return 1; },  
 2135970: () => { return Module.canvas.width; },  
 2136002: () => { return parseInt(Module.canvas.style.width); },  
 2136050: () => { document.exitFullscreen(); },  
 2136077: ($0) => { Module.canvas.style.opacity = $0; },  
 2136115: () => { return screen.width; },  
 2136140: () => { return screen.height; },  
 2136166: () => { return window.screenX; },  
 2136193: () => { return window.screenY; },  
 2136220: () => { return window.devicePixelRatio; },  
 2136256: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 2136309: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 2136360: () => { Module.canvas.style.cursor = 'none'; },  
 2136397: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 2136653: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 2136704: () => { if (document.pointerLockElement) return 1; },  
 2136751: () => { if (document.fullscreenElement) return 1; },  
 2136797: () => { return window.innerWidth; },  
 2136823: () => { return window.innerHeight; }
};
